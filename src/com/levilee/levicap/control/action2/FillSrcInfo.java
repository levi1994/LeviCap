...
public class FillSrcInfo implements ActionListener{
	private ViewSenderControler controler;
	private NetworkInterface device;
	public FillSrcInfo(ViewSenderControler controler,NetworkInterface device) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		controler.getSrc_ip().setText(ip1[1]);
		controler.getSrc_mac().setText(mac);
	}
